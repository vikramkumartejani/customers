...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar text-[#12121299] sticky top-0 h-full bg-white md:w-full min-w-fit w-fit lg:max-w-[319px] md:w-[250px] max-w-auto min-h-screen flex flex-col rounded-[24px] px-3 xl:px-8 md:px-6 pt-8">
